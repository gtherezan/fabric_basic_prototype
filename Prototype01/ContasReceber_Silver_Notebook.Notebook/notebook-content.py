...
df = spark.read.format("delta").load("abfss://9588b3b5-dfbe-4536-b0b1-395a2038b9d2@onelake.dfs.fabric.microsoft.com/1de3ddf0-d4ac-4b8a-ad80-93dc2b519092/Tables/ContasReceber")
...
df.write.format("delta").mode("overwrite").save(silverLakehouse + "ContasReceber")
